...
const DATOS_COLEGIO: Record<string, { nombre: string; director: string; admin: string }> = {
  ...
  CAN: { nombre: 'Mano Amiga Cancún',             director: 'Francisco Paul Martínez Contreras',  admin: 'Angel Martin Ku Uuh'               },
  ...
  GDL: { nombre: 'Mano Amiga Guadalajara',        director: 'Lorena López Taymani',               admin: 'Jose Ramón Iturbero Apecechea'     },
  ...
  SCA: { nombre: 'Mano Amiga Santa Catarina',     director: 'Jesús Gerardo Castillo Oliva',       admin: 'Alma Nelly Blanco López'           },
  ...
  TOR: { nombre: 'Mano Amiga Torreón',            director: 'Ma. Teresa Robles Limones',          admin: 'Jose Alberto Díaz Saldaña'         },
  VSJ: { nombre: 'Mano Amiga Villas De San Juan', director: 'Gonzalo Heredia Camacho',            admin: 'Ivonne Coss Sánchez'               },
  ZOM: { nombre: 'Mano Amiga Zomeyucan',          director: 'Edgar Omar Díaz Marías',             admin: 'Ana María Barrón Montaño'          },
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 text-slate-500 text-xs uppercase">
            <tr>
              ...
              <th className="text-left px-4 py-3 w-[180px]">Plantel</th>
